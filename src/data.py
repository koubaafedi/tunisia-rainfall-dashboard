...
def fetch_uk_data(param_type: str = "level") -> pd.DataFrame:
    ...
    try:
        ...
        try:
            today_url = f"https://environment.data.gov.uk/flood-monitoring/data/readings?today&parameter=level&qualifier=Groundwater&_limit=10000"
            ...
            if resp_today.status_code == 200:
                ...
                if t_items:
                    ...
                    def calc_trend(row):
                        ...
                        diff = lv - sv
                        threshold = 0.002 # 2mm threshold for groundwater stability
